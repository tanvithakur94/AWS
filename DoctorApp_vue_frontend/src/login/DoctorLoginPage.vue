<template>
    <div>
        <h2 class="title-style">Doctor Login</h2>
        <div class="login-part">
            ...
            <form @submit.prevent="handleSubmit">
                ...
                <div class="form-group">
                    ...
                    <router-link to="/doctor_register" class="btn btn-link">Register</router-link>
                </div>
            </form>
        </div>
    </div>
...
export default {
    ...
    methods: {
        ...mapActions('account', ['doctorlogin', 'logout']),
        handleSubmit (e) {
            this.submitted = true;
            const { username, password } = this;
            if (username && password) {
                this.doctorlogin({ username, password })
            }
        }
    }
};
