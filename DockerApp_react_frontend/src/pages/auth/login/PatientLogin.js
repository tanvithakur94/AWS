...
function PatientLogin (props) {
  ...
  const initialValues = {email: 'test2@email.com', password: 'Bgt54321!123'};

  const patientlogin = (user) => {
    authService.patientlogin(user)
    .then(
        user => {
          user.type = 0;
          setSubmitting(false);
          ...
          {({
            ...
            <form className="form" onSubmit={handleSubmit}>
                ...
                <div className="form-group">
                    ...
                    <input type="password" className={ errors.password && touched.password? "form-control is-invalid" : "form-control"} name="password" value={values.password}  onChange={handleChange} onBlur={handleBlur}/>
                ...
                <div className="text-center">
                    Don't have an account yet? <Link to="/patient-signup">Register here</Link>
                </div>
            </form>
          )}
          </Formik>
